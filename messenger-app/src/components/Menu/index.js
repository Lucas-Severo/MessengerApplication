...
function Menu() {
    ...
    function handleChangePaginaAtual(event, pagina) {
        ...
        document.querySelector(`#${paginaRenderizada}`).classList.remove('text-dark')
        dispatch(setPaginaAtual(paginaRenderizada))
    }
    ...
    return (
        <div className="menu d-flex flex-column justify-content-start border-end">
            <div className="d-flex flex-column align-items-center w-100 mt-2">
                <button className="btn btn-primary botaoNovo"><i className="fas fa-pencil-alt me-1"></i>Nova mensagem</button>
            </div>
